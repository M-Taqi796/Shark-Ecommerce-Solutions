...
const ServicesCard = ({ image, title, description }) => {
    ...
    return (
        <div className="w-full justify-center bg-background shadow text-fontWhite px-4 py-8 rounded-2xl flex flex-col items-center gap-4 hover:bg-primary hover:scale-105 transition-transform duration-300 group" onClick={() => navigate('/meeting')}>
