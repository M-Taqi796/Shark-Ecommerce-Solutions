const ServicesCard = ({ image, title, description }) => {
    return (
        <div className="bg-background shadow text-fontWhite px-4 py-8 rounded-2xl w-80 flex flex-col items-center gap-4 hover:bg-primary hover:scale-105 transition-transform duration-300 group">
            <img className="size-28" src={image} alt="" />
            <h2 className="text-md font-bold text-secondary group-hover:text-fontWhite">{title}</h2>
