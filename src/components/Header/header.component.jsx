    ...
    <section className="flex flex-col items-center mb-20">
      ...
      <div className="w-full px-20 max-[41.25rem]:px-4">
        <div className="bg-backgroundSecondary rounded-4xl py-16 w-full max-sm:py-8">
          ...
          <div className="flex justify-center px-40 max-[77.5rem]:px-20 max-[60rem]:px-10 gap-6 mt-12 max-[68.75rem]:flex-col max-[68.75rem]:items-center">
            <button className="text-fontWhite w-full py-3 bg-secondary shadow-[4px_4px_0px_0px] shadow-background hover:shadow-[0px_0px_0px_0px]" onClick={() => navigate("/meeting")}>Schedule a meeting</button>
            <button className="text-fontPrimary w-full py-3 bg-primary shadow-[4px_4px_0px_0px] shadow-background hover:shadow-[0px_0px_0px_0px]" onClick={() => navigate("/audit")}>Get a <span className="font-bold">Free</span> Audit Report</button>
          </div>
        </div>
      </div>
    </section>
