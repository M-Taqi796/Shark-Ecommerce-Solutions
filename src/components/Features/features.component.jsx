const Features = () => {
    return (
        <div className="grid grid-cols-4 mx-40 mb-20 gap-6 max-[75rem]:mx-20 max-[62.5rem]:grid-cols-2 max-[41.25rem]:mx-10 max-[26.5rem]:grid-cols-1">
            <div className="flex items-center gap-2 max-[75rem]:gap-1 w-full px-6 max-[75rem]:px-2 py-1.5 border border-fontSecondary rounded-md hover:scale-105 transition-all duration-300 hover:shadow-2xl">
