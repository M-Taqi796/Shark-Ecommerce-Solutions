        ...
        <motion.div initial={{y:100, opacity:0}} whileInView={{y:0, opacity:1}} transition={{duration:1, delay:0}}>
            <section className="bg-secondary p-6 flex items-center gap-14 mb-20 mx-36 rounded-3xl hover:scale-105 transition-transform duration-300">
                ...
                <article className="text-center">
                    ...
                    <button className="text-fontPrimary px-6 py-3 bg-background shadow-[4px_4px_0px_0px] shadow-backgroundSecondary hover:shadow-[0px_0px_0px_0px]" onClick={() => navigate("/meeting")}>Schedule a meeting</button>
                </article>
            </section>
        </motion.div>
    )
